...
public class ConstraintWidget {
    ...
    /* renamed from: mX */
    protected int f539mX;

    /* renamed from: mY */
    protected int f540mY;
    ...
    public String toString() {
        ...
        sb.append(str2);
        sb.append("(");
        sb.append(this.f539mX);
        sb.append(", ");
        sb.append(this.f540mY);
        sb.append(") - (");
    ...
    public int getRootX() {
        return this.f539mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f540mY + this.mOffsetY;
    }
    ...
    public void updateDrawPosition() {
        int i = this.f539mX;
        int i2 = this.f540mY;
        int i3 = this.f539mX + this.mWidth;
        this.mDrawX = i;
        this.mDrawY = i2;
        this.mDrawWidth = i3 - i;
        this.mDrawHeight = (this.f540mY + this.mHeight) - i2;
    }
    ...
    public void setDrawOrigin(int i, int i2) {
        ...
        this.f539mX = this.mDrawX;
        this.f540mY = this.mDrawY;
    }
    ...
    private void applyConstraints(android.support.constraint.solver.LinearSystem r31, boolean r32, android.support.constraint.solver.SolverVariable r33, android.support.constraint.solver.SolverVariable r34, android.support.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour r35, boolean r36, android.support.constraint.solver.widgets.ConstraintAnchor r37, android.support.constraint.solver.widgets.ConstraintAnchor r38, int r39, int r40, int r41, int r42, float r43, boolean r44, boolean r45, int r46, int r47, int r48, float r49, boolean r50) {
        ...
        L_0x0096:
            r6 = r46
        L_0x0098:
            int[] r15 = android.support.constraint.solver.widgets.ConstraintWidget.C02741.f542x27577131
            int r16 = r35.ordinal()
            r15 = r15[r16]
            r3 = 4
            switch(r15) {
