...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, (AttributeSet) null, C0510R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0510R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        /*
            ...
            r0.<init>()
            r7.mTempRect = r0
            int[] r0 = android.support.p037v7.appcompat.C0510R.styleable.Spinner
            r1 = 0
            android.support.v7.widget.TintTypedArray r0 = android.support.p037v7.widget.TintTypedArray.obtainStyledAttributes(r8, r9, r0, r10, r1)
            ...
            goto L_0x003e
        L_0x0023:
            int r12 = android.support.p037v7.appcompat.C0510R.styleable.Spinner_popupTheme
        ...
        L_0x007c:
            ...
            r11.<init>(r12, r9, r10)
            android.content.Context r12 = r7.mPopupContext
            int[] r4 = android.support.p037v7.appcompat.C0510R.styleable.Spinner
            android.support.v7.widget.TintTypedArray r12 = android.support.p037v7.widget.TintTypedArray.obtainStyledAttributes(r12, r9, r4, r10, r1)
            int r1 = android.support.p037v7.appcompat.C0510R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r1 = r12.getLayoutDimension((int) r1, (int) r4)
            r7.mDropDownWidth = r1
            int r1 = android.support.p037v7.appcompat.C0510R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r1 = r12.getDrawable(r1)
            r11.setBackgroundDrawable(r1)
            int r1 = android.support.p037v7.appcompat.C0510R.styleable.Spinner_android_prompt
        ...
        L_0x00b4:
            int r11 = android.support.p037v7.appcompat.C0510R.styleable.Spinner_android_entries
            ...
            r12.<init>(r8, r1, r11)
            int r8 = android.support.p037v7.appcompat.C0510R.layout.support_simple_spinner_dropdown_item
        ...
        L_0x00dc:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p037v7.widget.AppCompatSpinner.<init>(android.content.Context, android.util.AttributeSet, int, int, android.content.res.Resources$Theme):void");
    }
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        public void show() {
            ...
            if (!isShowing && (viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                final C05442 r1 = new ViewTreeObserver.OnGlobalLayoutListener() {
