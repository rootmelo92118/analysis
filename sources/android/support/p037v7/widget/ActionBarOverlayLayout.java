...
import android.support.p034v4.view.NestedScrollingParent;
import android.support.p034v4.view.NestedScrollingParentHelper;
...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = {C0510R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0510R.C0512id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0510R.C0512id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0510R.C0512id.action_bar));
        }
    }
