...
import android.support.p034v4.widget.ListViewAutoScrollHelper;
...
class DropDownListView extends ListViewCompat {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, (AttributeSet) null, C0510R.attr.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
    }
    ...
    public boolean onForwardedEvent(android.view.MotionEvent r8, int r9) {
        /*
            r7 = this;
            int r0 = android.support.p034v4.view.MotionEventCompat.getActionMasked(r8)
            r1 = 0
            r2 = 1
            switch(r0) {
        ...
        L_0x0069:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p037v7.widget.DropDownListView.onForwardedEvent(android.view.MotionEvent, int):boolean");
    }
