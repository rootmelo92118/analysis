...
import android.support.p034v4.widget.NestedScrollView;
...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0510R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0510R.styleable.AlertDialog, C0510R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0510R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0510R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0510R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0510R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0510R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0510R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0510R.styleable.AlertDialog_showTitle, true);
    ...
    private void setupView() {
        View findViewById;
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0510R.C0512id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0510R.C0512id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0510R.C0512id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0510R.C0512id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0510R.C0512id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0510R.C0512id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0510R.C0512id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0510R.C0512id.buttonPanel);
        ...
        if (!(z3 || resolvePanel2 == null || (findViewById2 = resolvePanel2.findViewById(C0510R.C0512id.textSpacerNoButtons)) == null)) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null && !z) && !z) {
                view = resolvePanel.findViewById(C0510R.C0512id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (!(resolvePanel2 == null || (findViewById = resolvePanel2.findViewById(C0510R.C0512id.textSpacerNoTitle)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0510R.C0512id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0510R.C0512id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0510R.C0512id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0510R.C0512id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0510R.C0512id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0510R.C0512id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0510R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0510R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0510R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public static class AlertParams {
        ...
        private void createListView(final android.support.p037v7.app.AlertController r11) {
            /*
                r10 = this;
                ...
                android.support.v7.app.AlertController$RecycleListView r0 = (android.support.p037v7.app.AlertController.RecycleListView) r0
            ...
            L_0x00af:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p037v7.app.AlertController.AlertParams.createListView(android.support.v7.app.AlertController):void");
        }
    }
