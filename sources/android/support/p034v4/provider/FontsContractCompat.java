...
import android.support.p034v4.graphics.TypefaceCompatUtil;
import android.support.p034v4.provider.SelfDestructiveThread;
...
public class FontsContractCompat {
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, @Nullable final TextView textView, int i, int i2, final int i3) {
        ...
        C04171 r1 = new Callable<Typeface>() {
        ...
        if (z) {
            ...
            C04182 r5 = new SelfDestructiveThread.ReplyCallback<Typeface>() {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo487to = 1000) int i2, boolean z, int i3) {
