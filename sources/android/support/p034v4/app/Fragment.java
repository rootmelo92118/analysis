...
public class Fragment implements C0257c, ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    C0258d mLifecycleRegistry = new C0258d(this);
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (this.mCalled) {
            this.mLifecycleRegistry.mo463a(C0254b.C0255a.ON_CREATE);
            return;
        }
    ...
    public void performStart() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.mo463a(C0254b.C0255a.ON_START);
            return;
        }
    ...
    public void performResume() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.mo463a(C0254b.C0255a.ON_RESUME);
            return;
        }
    ...
    public void performPause() {
        this.mLifecycleRegistry.mo463a(C0254b.C0255a.ON_PAUSE);
        if (this.mChildFragmentManager != null) {
    ...
    public void performStop() {
        this.mLifecycleRegistry.mo463a(C0254b.C0255a.ON_STOP);
        if (this.mChildFragmentManager != null) {
    ...
    public void performDestroy() {
        this.mLifecycleRegistry.mo463a(C0254b.C0255a.ON_DESTROY);
        if (this.mChildFragmentManager != null) {
