...
import android.support.compat.C0266R;
import android.support.p034v4.app.NotificationCompatApi20;
import android.support.p034v4.app.NotificationCompatApi21;
import android.support.p034v4.app.NotificationCompatApi24;
import android.support.p034v4.app.NotificationCompatApi26;
import android.support.p034v4.app.NotificationCompatBase;
import android.support.p034v4.app.NotificationCompatJellybean;
import android.support.p034v4.app.NotificationCompatKitKat;
import android.support.p034v4.app.RemoteInputCompatBase;
...
public class NotificationCompat {
    ...
    static class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Bundle extras;
            Builder builder2 = builder;
            NotificationCompatJellybean.Builder builder3 = new NotificationCompatJellybean.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder3);
            }
            Notification build = builderExtender.build(builder2, builder3);
            if (!(builder2.mStyle == null || (extras = NotificationCompat.getExtras(build)) == null)) {
    ...
    static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            NotificationCompatKitKat.Builder builder3 = new NotificationCompatKitKat.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder3);
            }
    ...
    static class NotificationCompatApi20Impl extends NotificationCompatApi19Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            NotificationCompatApi20.Builder builder3 = new NotificationCompatApi20.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView, builder.mGroupAlertBehavior);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder3);
            }
    ...
    static class NotificationCompatApi21Impl extends NotificationCompatApi20Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            NotificationCompatApi21.Builder builder3 = new NotificationCompatApi21.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder.mGroupAlertBehavior);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder3);
            }
    ...
    static class NotificationCompatApi24Impl extends NotificationCompatApi21Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            NotificationCompatApi24.Builder builder3 = new NotificationCompatApi24.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mRemoteInputHistory, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder.mGroupAlertBehavior);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder3);
            }
    ...
    static class NotificationCompatApi26Impl extends NotificationCompatApi24Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            NotificationCompatApi26.Builder builder3 = new NotificationCompatApi26.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mRemoteInputHistory, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder2.mChannelId, builder2.mBadgeIcon, builder2.mShortcutId, builder2.mTimeout, builder2.mColorized, builder2.mColorizedSet, builder.mGroupAlertBehavior);
            NotificationCompat.addActionsToBuilder(builder3, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder3);
            }
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x0023:
                ...
                int r14 = android.support.compat.C0266R.C0268id.notification_background
                java.lang.String r2 = "setBackgroundResource"
                int r4 = android.support.compat.C0266R.C0267drawable.notification_bg_low
                r7.setInt(r14, r2, r4)
                int r14 = android.support.compat.C0266R.C0268id.icon
                java.lang.String r2 = "setBackgroundResource"
                int r4 = android.support.compat.C0266R.C0267drawable.notification_template_icon_low_bg
                r7.setInt(r14, r2, r4)
                goto L_0x0056
            L_0x0044:
                int r14 = android.support.compat.C0266R.C0268id.notification_background
                java.lang.String r2 = "setBackgroundResource"
                int r4 = android.support.compat.C0266R.C0267drawable.notification_bg
                r7.setInt(r14, r2, r4)
                int r14 = android.support.compat.C0266R.C0268id.icon
                java.lang.String r2 = "setBackgroundResource"
                int r4 = android.support.compat.C0266R.C0267drawable.notification_template_icon_bg
                r7.setInt(r14, r2, r4)
            L_0x0056:
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0076:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x010a
                int r13 = android.support.compat.C0266R.dimen.notification_right_icon_size
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = android.support.compat.C0266R.dimen.notification_small_icon_background_padding
                ...
                int r14 = android.support.compat.C0266R.C0268id.right_icon
                r7.setImageViewBitmap(r14, r13)
                goto L_0x00b9
            L_0x00aa:
                int r13 = android.support.compat.C0266R.C0268id.right_icon
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x00bf:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x010a
                int r13 = android.support.compat.C0266R.C0268id.icon
                r7.setViewVisibility(r13, r9)
                int r13 = android.os.Build.VERSION.SDK_INT
                if (r13 < r3) goto L_0x00fb
                int r13 = android.support.compat.C0266R.dimen.notification_large_icon_width
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = android.support.compat.C0266R.dimen.notification_big_circle_margin
                int r14 = r0.getDimensionPixelSize(r14)
                int r13 = r13 - r14
                int r14 = android.support.compat.C0266R.dimen.notification_small_icon_size_as_large
                int r14 = r0.getDimensionPixelSize(r14)
                android.support.v4.app.NotificationCompat$Builder r1 = r12.mBuilder
                android.app.Notification r1 = r1.mNotification
                int r1 = r1.icon
            ...
            L_0x010a:
                ...
                int r13 = android.support.compat.C0266R.C0268id.title
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0119:
                ...
                int r13 = android.support.compat.C0266R.C0268id.text
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0138:
                ...
                int r13 = android.support.compat.C0266R.C0268id.info
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x014f:
                ...
                int r13 = android.support.compat.C0266R.integer.status_bar_notification_info_maxnum
                int r13 = r0.getInteger(r13)
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
                int r14 = r14.mNumber
                if (r14 <= r13) goto L_0x016d
                int r13 = android.support.compat.C0266R.C0268id.info
                int r14 = android.support.compat.C0266R.string.status_bar_notification_info_overflow
                java.lang.String r14 = r0.getString(r14)
                r7.setTextViewText(r13, r14)
                goto L_0x017f
            L_0x016d:
                java.text.NumberFormat r13 = java.text.NumberFormat.getIntegerInstance()
                int r14 = android.support.compat.C0266R.C0268id.info
                android.support.v4.app.NotificationCompat$Builder r1 = r12.mBuilder
                int r1 = r1.mNumber
                long r1 = (long) r1
            ...
            L_0x017f:
                ...
                goto L_0x014c
            L_0x0185:
                int r1 = android.support.compat.C0266R.C0268id.info
            ...
            L_0x018a:
                ...
                int r1 = android.support.compat.C0266R.C0268id.text
                android.support.v4.app.NotificationCompat$Builder r2 = r12.mBuilder
                ...
                int r1 = android.support.compat.C0266R.C0268id.text2
                android.support.v4.app.NotificationCompat$Builder r2 = r12.mBuilder
            ...
            L_0x01b9:
                ...
                int r15 = android.support.compat.C0266R.dimen.notification_subtext_size
                int r15 = r0.getDimensionPixelSize(r15)
                float r15 = (float) r15
                int r0 = android.support.compat.C0266R.C0268id.text
                r7.setTextViewTextSize(r0, r9, r15)
            L_0x01cd:
                int r2 = android.support.compat.C0266R.C0268id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x01d7:
                ...
                int r14 = android.support.compat.C0266R.C0268id.chronometer
                r7.setViewVisibility(r14, r9)
                int r14 = android.support.compat.C0266R.C0268id.chronometer
                ...
                goto L_0x0223
            L_0x0211:
                int r14 = android.support.compat.C0266R.C0268id.time
                r7.setViewVisibility(r14, r9)
                int r14 = android.support.compat.C0266R.C0268id.time
            ...
            L_0x0223:
                r14 = 1
            L_0x0224:
                int r15 = android.support.compat.C0266R.C0268id.right_side
            ...
            L_0x022c:
                ...
                int r14 = android.support.compat.C0266R.C0268id.line3
            ...
            L_0x0236:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p034v4.app.NotificationCompat.Style.applyStandardTemplate(boolean, int, boolean):android.widget.RemoteViews");
        }
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0266R.C0267drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0266R.C0268id.notification_main_column);
            remoteViews.addView(C0266R.C0268id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0266R.C0268id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0266R.C0268id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0266R.C0268id.title, 8);
            remoteViews.setViewVisibility(C0266R.C0268id.text2, 8);
            remoteViews.setViewVisibility(C0266R.C0268id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0266R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0266R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0266R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0266R.C0268id.actions);
            if (!z || this.mBuilder.mActions == null || (min = Math.min(this.mBuilder.mActions.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0266R.C0268id.actions, generateActionButton(this.mBuilder.mActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0266R.C0268id.actions, i);
            applyStandardTemplate.setViewVisibility(C0266R.C0268id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0266R.layout.notification_action_tombstone : C0266R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0266R.C0268id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0266R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0266R.C0268id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0266R.C0268id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0266R.C0268id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class Action extends NotificationCompatBase.Action {
        ...
        public static final class Builder {
            ...
            /* Code decompiled incorrectly, please refer to instructions dump. */
            public android.support.p034v4.app.NotificationCompat.Action build() {
                /*
                    r12 = this;
                ...
                L_0x0014:
                    ...
                    android.support.v4.app.RemoteInput r3 = (android.support.p034v4.app.RemoteInput) r3
                ...
                L_0x0037:
                    int r2 = r0.size()
                    android.support.v4.app.RemoteInput[] r2 = new android.support.p034v4.app.RemoteInput[r2]
                    java.lang.Object[] r0 = r0.toArray(r2)
                    android.support.v4.app.RemoteInput[] r0 = (android.support.p034v4.app.RemoteInput[]) r0
                    r10 = r0
                L_0x0044:
                ...
                L_0x004c:
                    int r0 = r1.size()
                    android.support.v4.app.RemoteInput[] r0 = new android.support.p034v4.app.RemoteInput[r0]
                ...
                L_0x005a:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: android.support.p034v4.app.NotificationCompat.Action.Builder.build():android.support.v4.app.NotificationCompat$Action");
            }
        }
