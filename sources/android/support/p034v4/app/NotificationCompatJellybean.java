...
class NotificationCompatJellybean {
    ...
    public static class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        ...
        /* renamed from: b */
        private Notification.Builder f552b;
        ...
        public Builder(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, int i4, CharSequence charSequence4, boolean z3, Bundle bundle, String str, boolean z4, String str2, RemoteViews remoteViews2, RemoteViews remoteViews3) {
            ...
            this.f552b = deleteIntent.setFullScreenIntent(pendingIntent3, z5).setLargeIcon(bitmap).setNumber(i).setUsesChronometer(z2).setPriority(i4).setProgress(i2, i3, z);
        ...
        public void addAction(NotificationCompatBase.Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f552b, action));
        }
        ...
        public Notification build() {
            Notification build = this.f552b.build();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0012, code lost:
        r8 = r8.getSparseParcelableArray(android.support.p034v4.app.NotificationCompatExtras.EXTRA_ACTION_EXTRAS);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.support.p034v4.app.NotificationCompatBase.Action getAction(android.app.Notification r8, int r9, android.support.p034v4.app.NotificationCompatBase.Action.Factory r10, android.support.p034v4.app.RemoteInputCompatBase.RemoteInput.Factory r11) {
        /*
            java.lang.Object r0 = sActionsLock
            monitor-enter(r0)
            r1 = 0
            java.lang.Object[] r2 = getActionObjectsLocked(r8)     // Catch:{ IllegalAccessException -> 0x0045 }
            if (r2 == 0) goto L_0x0050
            r2 = r2[r9]     // Catch:{ IllegalAccessException -> 0x0045 }
            android.os.Bundle r8 = getExtras(r8)     // Catch:{ IllegalAccessException -> 0x0045 }
            if (r8 == 0) goto L_0x0022
            java.lang.String r3 = "android.support.actionExtras"
            android.util.SparseArray r8 = r8.getSparseParcelableArray(r3)     // Catch:{ IllegalAccessException -> 0x0045 }
            if (r8 == 0) goto L_0x0022
            java.lang.Object r8 = r8.get(r9)     // Catch:{ IllegalAccessException -> 0x0045 }
            android.os.Bundle r8 = (android.os.Bundle) r8     // Catch:{ IllegalAccessException -> 0x0045 }
            r7 = r8
            goto L_0x0023
        L_0x0022:
            r7 = r1
        L_0x0023:
            java.lang.reflect.Field r8 = sActionIconField     // Catch:{ IllegalAccessException -> 0x0045 }
            int r4 = r8.getInt(r2)     // Catch:{ IllegalAccessException -> 0x0045 }
            java.lang.reflect.Field r8 = sActionTitleField     // Catch:{ IllegalAccessException -> 0x0045 }
            java.lang.Object r8 = r8.get(r2)     // Catch:{ IllegalAccessException -> 0x0045 }
            r5 = r8
            java.lang.CharSequence r5 = (java.lang.CharSequence) r5     // Catch:{ IllegalAccessException -> 0x0045 }
            java.lang.reflect.Field r8 = sActionIntentField     // Catch:{ IllegalAccessException -> 0x0045 }
            java.lang.Object r8 = r8.get(r2)     // Catch:{ IllegalAccessException -> 0x0045 }
            r6 = r8
            android.app.PendingIntent r6 = (android.app.PendingIntent) r6     // Catch:{ IllegalAccessException -> 0x0045 }
            r2 = r10
            r3 = r11
            android.support.v4.app.NotificationCompatBase$Action r8 = readAction(r2, r3, r4, r5, r6, r7)     // Catch:{ IllegalAccessException -> 0x0045 }
        ...
        L_0x0045:
            ...
            android.util.Log.e(r9, r10, r8)     // Catch:{ all -> 0x0043 }
            r8 = 1
        ...
        L_0x0052:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p034v4.app.NotificationCompatJellybean.getAction(android.app.Notification, int, android.support.v4.app.NotificationCompatBase$Action$Factory, android.support.v4.app.RemoteInputCompatBase$RemoteInput$Factory):android.support.v4.app.NotificationCompatBase$Action");
    }
