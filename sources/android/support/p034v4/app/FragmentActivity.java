...
public class FragmentActivity extends BaseFragmentActivityApi16 implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public void onSaveInstanceState(Bundle bundle) {
        ...
        markState(getSupportFragmentManager(), C0254b.C0256b.CREATED);
    ...
    private static void markState(FragmentManager fragmentManager, C0254b.C0256b bVar) {
        for (Fragment next : fragmentManager.getFragments()) {
            if (next != null) {
                next.mLifecycleRegistry.mo464a(bVar);
                markState(next.getChildFragmentManager(), bVar);
            }
        }
    }
}
