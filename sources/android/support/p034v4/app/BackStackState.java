...
import android.support.p034v4.app.BackStackRecord;
...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        if (backStackRecord.mAddToBackStack) {
            ...
            int i2 = 0;
            while (i < size) {
                BackStackRecord.C0314Op op = backStackRecord.mOps.get(i);
                int i3 = i2 + 1;
                this.mOps[i2] = op.cmd;
                int i4 = i3 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i < this.mOps.length) {
            BackStackRecord.C0314Op op = new BackStackRecord.C0314Op();
            int i3 = i + 1;
            op.cmd = this.mOps[i];
