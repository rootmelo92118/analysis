package android.support.p034v4.content.res;
...
import android.support.p034v4.provider.FontRequest;
...
public class FontResourcesParserCompat {
    ...
    public static android.support.p034v4.content.res.FontResourcesParserCompat.FamilyResourceEntry parse(org.xmlpull.v1.XmlPullParser r3, android.content.res.Resources r4) {
        /*
        L_0x0000:
            int r0 = r3.next()
            r1 = 2
        ...
        L_0x0012:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p034v4.content.res.FontResourcesParserCompat.parse(org.xmlpull.v1.XmlPullParser, android.content.res.Resources):android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry");
    }
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0266R.styleable.FontFamily);
        String string = obtainAttributes.getString(C0266R.styleable.FontFamily_fontProviderAuthority);
        String string2 = obtainAttributes.getString(C0266R.styleable.FontFamily_fontProviderPackage);
        String string3 = obtainAttributes.getString(C0266R.styleable.FontFamily_fontProviderQuery);
        int resourceId = obtainAttributes.getResourceId(C0266R.styleable.FontFamily_fontProviderCerts, 0);
        int integer = obtainAttributes.getInteger(C0266R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int integer2 = obtainAttributes.getInteger(C0266R.styleable.FontFamily_fontProviderFetchTimeout, DEFAULT_TIMEOUT_MILLIS);
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0266R.styleable.FontFamilyFont);
        int i = obtainAttributes.getInt(C0266R.styleable.FontFamilyFont_fontWeight, NORMAL_WEIGHT);
        boolean z = true;
        if (1 != obtainAttributes.getInt(C0266R.styleable.FontFamilyFont_fontStyle, 0)) {
            z = false;
        }
        int resourceId = obtainAttributes.getResourceId(C0266R.styleable.FontFamilyFont_font, 0);
        String string = obtainAttributes.getString(C0266R.styleable.FontFamilyFont_font);
        obtainAttributes.recycle();
        while (xmlPullParser.next() != 3) {
            skip(xmlPullParser);
        }
