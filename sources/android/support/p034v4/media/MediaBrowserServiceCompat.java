...
import android.support.p034v4.media.MediaBrowserCompat;
import android.support.p034v4.media.MediaBrowserServiceCompatApi21;
import android.support.p034v4.media.MediaBrowserServiceCompatApi23;
import android.support.p034v4.media.MediaBrowserServiceCompatApi24;
import android.support.p034v4.media.session.IMediaSession;
import android.support.p034v4.media.session.MediaSessionCompat;
import android.support.p034v4.p036os.ResultReceiver;
...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle) {
        ...
        final String str2 = str;
        final Bundle bundle2 = bundle;
        C03741 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03752 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03763 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03774 r0 = new Result<Bundle>(str) {
            /* access modifiers changed from: package-private */
