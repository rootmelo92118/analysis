...
import android.support.p034v4.media.MediaDescriptionCompat;
import android.support.p034v4.media.MediaMetadataCompat;
import android.support.p034v4.media.RatingCompat;
import android.support.p034v4.media.VolumeProviderCompat;
import android.support.p034v4.media.session.IMediaSession;
import android.support.p034v4.media.session.MediaSessionCompatApi21;
import android.support.p034v4.media.session.MediaSessionCompatApi23;
import android.support.p034v4.media.session.MediaSessionCompatApi24;
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r3, android.os.Bundle r4, android.os.ResultReceiver r5) {
                /*
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.p034v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e7 }
                    ...
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r3 = (android.support.p034v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r3     // Catch:{ BadParcelableException -> 0x00e7 }
                ...
                L_0x002d:
                    android.support.p034v4.app.BundleCompat.putBinder(r4, r0, r1)     // Catch:{ BadParcelableException -> 0x00e7 }
                    r3 = 0
                ...
                L_0x0036:
                    ...
                    java.lang.Class<android.support.v4.media.MediaDescriptionCompat> r3 = android.support.p034v4.media.MediaDescriptionCompat.class
                    ...
                    android.support.v4.media.MediaDescriptionCompat r4 = (android.support.p034v4.media.MediaDescriptionCompat) r4     // Catch:{ BadParcelableException -> 0x00e7 }
                ...
                L_0x0056:
                    ...
                    android.support.v4.media.MediaDescriptionCompat r5 = (android.support.p034v4.media.MediaDescriptionCompat) r5     // Catch:{ BadParcelableException -> 0x00e7 }
                ...
                L_0x009b:
                    ...
                    r1 = r3
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r1 = (android.support.p034v4.media.session.MediaSessionCompat.QueueItem) r1     // Catch:{ BadParcelableException -> 0x00e7 }
                L_0x00d5:
                    ...
                    goto L_0x00ee
                L_0x00e1:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.p034v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e7 }
                ...
                L_0x00ee:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: android.support.p034v4.media.session.MediaSessionCompat.Callback.StubApi21.onCommand(java.lang.String, android.os.Bundle, android.os.ResultReceiver):void");
            }
