package android.support.p034v4.media.app;
...
import android.support.mediacompat.C0303R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public static MediaSessionCompat.Token getMediaSession(Notification notification) {
            Bundle extras = android.support.p034v4.app.NotificationCompat.getExtras(notification);
            if (extras == null) {
                return null;
            }
        ...
        public RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0303R.C0305id.media_actions);
            if (i > 0) {
                int i2 = 0;
                while (i2 < i) {
                    if (i2 < size) {
                        applyStandardTemplate.addView(C0303R.C0305id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                        i2++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0303R.C0305id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0303R.C0305id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0303R.C0305id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0303R.C0305id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0303R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0303R.C0305id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0303R.C0305id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0303R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0303R.C0305id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0303R.C0305id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0303R.C0305id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        public int getContentViewLayoutResource() {
            return C0303R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0303R.C0305id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0303R.C0305id.cancel_action, 0);
        ...
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0303R.layout.notification_template_big_media_narrow : C0303R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0303R.layout.notification_template_media_custom;
            }
        ...
        /* access modifiers changed from: package-private */
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0303R.layout.notification_template_big_media_narrow_custom : C0303R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                i = this.mBuilder.mContext.getResources().getColor(C0303R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0303R.C0305id.status_bar_latest_event_content, "setBackgroundColor", i);
        }
    }
}
