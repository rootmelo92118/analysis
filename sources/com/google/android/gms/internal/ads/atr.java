...
abstract class atr {
    ...
    /* renamed from: a */
    public abstract int mo11225a(int i, byte[] bArr, int i2, int i3);

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract int mo11226a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract void mo11227a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public abstract String mo11229b(byte[] bArr, int i, int i2);

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public final boolean mo11228a(byte[] bArr, int i, int i2) {
        return mo11225a(0, bArr, i, i2) == 0;
    }

    /* renamed from: b */
    static void m4029b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
