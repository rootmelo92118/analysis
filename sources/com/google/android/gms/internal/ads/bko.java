...
public final class bko {
    /* renamed from: a */
    public static String m5804a(String str, String str2) {
        ...
        if (a[3] == 0) {
            ...
            sb.append(str, 0, i);
            sb.append(str2);
            return m5805a(sb, a[1] + i, i + a[2]);
        } else if (str2.charAt(a[1]) == '/') {
            sb.append(str, 0, a2[1]);
            sb.append(str2);
            return m5805a(sb, a2[1], a2[1] + a[2]);
        } else if (a2[0] + 2 >= a2[1] || a2[1] != a2[2]) {
            int lastIndexOf = str.lastIndexOf(47, a2[2] - 1);
            int i2 = lastIndexOf == -1 ? a2[1] : lastIndexOf + 1;
            sb.append(str, 0, i2);
            sb.append(str2);
            return m5805a(sb, a2[1], i2 + a[2]);
        } else {
            sb.append(str, 0, a2[1]);
            sb.append('/');
            sb.append(str2);
            return m5805a(sb, a2[1], a2[1] + a[2] + 1);
        }
    }

    /* renamed from: a */
    private static String m5805a(StringBuilder sb, int i, int i2) {
        int i3;
        if (i >= i2) {
            return sb.toString();
        }
    ...
    /* renamed from: a */
    private static int[] m5806a(String str) {
        int i;
        int[] iArr = new int[4];
