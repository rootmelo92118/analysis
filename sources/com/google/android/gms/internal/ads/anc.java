...
public final class anc implements aio {

    /* renamed from: a */
    private final SecretKey f2074a;

    public anc(byte[] bArr) {
        aol.m2927a(bArr.length);
        this.f2074a = new SecretKeySpec(bArr, "AES");
    }
    ...
    public final byte[] mo10588a(byte[] bArr, byte[] bArr2) {
        if (bArr.length <= 2147483619) {
            ...
            byte[] a = aof.m2913a(12);
            System.arraycopy(a, 0, bArr3, 0, 12);
            Cipher a2 = ans.f2111a.mo10740a("AES/GCM/NoPadding");
            a2.init(1, this.f2074a, m2865a(a, 0, a.length));
    ...
    /* renamed from: a */
    private static AlgorithmParameterSpec m2865a(byte[] bArr, int i, int i2) {
        try {
