...
@C1598qn
@KeepName
public class HttpClient implements zzu<C1339gy> {
    ...
    private static zzb zzc(JSONObject jSONObject) {
        ...
        try {
            ...
            C1772wz.m1625b("Error constructing http request.", e);
        }
    ...
    private static JSONObject zza(zzd zzd2) {
        ...
        try {
            ...
            C1772wz.m1625b("Error constructing JSON for http response.", e);
        }
        return jSONObject;
    }
    ...
    private final com.google.android.gms.ads.internal.gmsg.HttpClient.zzc zza(com.google.android.gms.ads.internal.gmsg.HttpClient.zzb r13) {
        /*
            ...
            com.google.android.gms.internal.ads.xi r3 = com.google.android.gms.ads.internal.zzbv.zzlf()     // Catch:{ Exception -> 0x00eb }
            ...
            java.lang.String r5 = r5.f7135a     // Catch:{ Exception -> 0x00eb }
            r3.mo13203a((android.content.Context) r4, (java.lang.String) r5, (boolean) r0, (java.net.HttpURLConnection) r2)     // Catch:{ Exception -> 0x00eb }
        ...
        L_0x0064:
            r3 = r1
        L_0x0065:
            com.google.android.gms.internal.ads.aab r5 = new com.google.android.gms.internal.ads.aab     // Catch:{ Exception -> 0x00eb }
            r5.<init>()     // Catch:{ Exception -> 0x00eb }
            r5.mo10031a((java.net.HttpURLConnection) r2, (byte[]) r3)     // Catch:{ Exception -> 0x00eb }
        ...
        L_0x00b5:
            ...
            java.lang.String r8 = com.google.android.gms.internal.ads.C1782xi.m8365a((java.io.InputStreamReader) r8)     // Catch:{ Exception -> 0x00eb }
            r6.<init>(r13, r7, r3, r8)     // Catch:{ Exception -> 0x00eb }
            int r13 = r6.getResponseCode()     // Catch:{ Exception -> 0x00eb }
            r5.mo10030a((java.net.HttpURLConnection) r2, (int) r13)     // Catch:{ Exception -> 0x00eb }
            java.lang.String r13 = r6.getBody()     // Catch:{ Exception -> 0x00eb }
            r5.mo10028a((java.lang.String) r13)     // Catch:{ Exception -> 0x00eb }
    ...
    public JSONObject send(JSONObject jSONObject) {
        ...
        try {
            ...
            try {
                ...
                e = e;
                C1772wz.m1625b("Error executing http request.", e);
                try {
                    jSONObject2.put("response", new JSONObject().put("http_request_id", str));
                    jSONObject2.put("success", false);
                    jSONObject2.put("reason", e.toString());
                } catch (JSONException e2) {
                    C1772wz.m1625b("Error executing http request.", e2);
                }
                return jSONObject2;
            }
        } catch (Exception e3) {
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        C1780xg.m8353a((Runnable) new zzv(this, map, (C1339gy) obj));
    }
}
