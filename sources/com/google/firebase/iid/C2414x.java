...
public final class C2414x {

    /* renamed from: b */
    private static C2414x f8925b;
    @VisibleForTesting

    /* renamed from: a */
    final Queue<Intent> f8926a = new ArrayDeque();
    @GuardedBy("serviceClassNames")

    /* renamed from: c */
    private final SimpleArrayMap<String, String> f8927c = new SimpleArrayMap<>();

    /* renamed from: d */
    private Boolean f8928d = null;
    @VisibleForTesting

    /* renamed from: e */
    private final Queue<Intent> f8929e = new ArrayDeque();

    /* renamed from: a */
    public static synchronized C2414x m11759a() {
        C2414x xVar;
        synchronized (C2414x.class) {
            if (f8925b == null) {
                f8925b = new C2414x();
            }
            xVar = f8925b;
    ...
    /* renamed from: a */
    public static void m11760a(Context context, Intent intent) {
        context.sendBroadcast(m11761b(context, "com.google.firebase.INSTANCE_ID_EVENT", intent));
    }

    /* renamed from: b */
    public static void m11762b(Context context, Intent intent) {
        context.sendBroadcast(m11761b(context, "com.google.firebase.MESSAGING_EVENT", intent));
    }

    /* renamed from: b */
    private static Intent m11761b(Context context, String str, Intent intent) {
    ...
    /* renamed from: a */
    public final int mo15040a(Context context, String str, Intent intent) {
        ...
        switch (c) {
            case 0:
                this.f8926a.offer(intent);
                break;
            case 1:
                this.f8929e.offer(intent);
                break;
            default:
        ...
        return m11763c(context, intent2);
    }
    ...
    private final int m11763c(android.content.Context r7, android.content.Intent r8) {
        /*
            r6 = this;
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r0 = r6.f8927c
            monitor-enter(r0)
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r1 = r6.f8927c     // Catch:{ all -> 0x0143 }
        ...
        L_0x0057:
            ...
            r1.<init>(r2)
        L_0x005c:
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r2 = r6.f8927c
            monitor-enter(r2)
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r3 = r6.f8927c     // Catch:{ all -> 0x006a }
        ...
        L_0x00d7:
            java.lang.Boolean r1 = r6.f8928d     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
        ...
        L_0x00e4:
            ...
            r6.f8928d = r0     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
        L_0x00ea:
            java.lang.Boolean r0 = r6.f8928d     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
            boolean r0 = r0.booleanValue()     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
            if (r0 == 0) goto L_0x00f7
            android.content.ComponentName r7 = android.support.p034v4.content.WakefulBroadcastReceiver.startWakefulService(r7, r8)     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
            goto L_0x0102
        L_0x00f7:
        ...
        L_0x0143:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.C2414x.m11763c(android.content.Context, android.content.Intent):int");
    }
}
