...
class FirebaseAnalyticsApiAdapter {
    ...
    public void processEvent(SessionEvent sessionEvent) {
        ...
        if (firebaseAnalytics == null) {
            C0139c.m394g().mo281a(Answers.TAG, "Firebase analytics logging was enabled, but not available...");
            return;
        }
        FirebaseAnalyticsEvent mapEvent = this.eventMapper.mapEvent(sessionEvent);
        if (mapEvent == null) {
            C0153l g = C0139c.m394g();
            g.mo281a(Answers.TAG, "Fabric event was not mappable to Firebase event: " + sessionEvent);
            return;
        }
