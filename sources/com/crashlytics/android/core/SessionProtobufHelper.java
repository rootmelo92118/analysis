...
class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i, String str, int i2, long j, long j2, boolean z, Map<C0036r.C0037a, String> map, int i3, String str2, String str3) {
        ...
        for (Map.Entry next : map.entrySet()) {
            ...
            codedOutputStream2.writeRawVarint32(getDeviceIdentifierSize((C0036r.C0037a) next.getKey(), (String) next.getValue()));
            codedOutputStream2.writeEnum(1, ((C0036r.C0037a) next.getKey()).f75h);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, Float f, int i2, boolean z, long j2, long j3) {
        ...
        if (byteStringForLog == null) {
            C0139c.m394g().mo281a(CrashlyticsCore.TAG, "No log data to include with this event.");
        }
        ...
        writeSessionEventApp(codedOutputStream, trimmedThrowableData, thread, stackTraceElementArr, threadArr, list, 8, copyFromUtf82, byteString, map, runningAppProcessInfo, i);
    ...
    private static int getDeviceIdentifierSize(C0036r.C0037a aVar, String str) {
        return CodedOutputStream.computeEnumSize(1, aVar.f75h) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(str));
    }

    private static int getSessionDeviceSize(int i, ByteString byteString, int i2, long j, long j2, boolean z, Map<C0036r.C0037a, String> map, int i3, ByteString byteString2, ByteString byteString3) {
        int i4;
        int i5;
        int i6 = 0;
        ...
        if (map != null) {
            for (Map.Entry next : map.entrySet()) {
                int deviceIdentifierSize = getDeviceIdentifierSize((C0036r.C0037a) next.getKey(), (String) next.getValue());
