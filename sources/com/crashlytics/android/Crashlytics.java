...
import p000a.p001a.p002a.p003a.C0151j;

public class Crashlytics extends C0150i<Void> implements C0151j {
    public static final String TAG = "Crashlytics";
    public final Answers answers;
    public final Beta beta;
    public final CrashlyticsCore core;
    public final Collection<? extends C0150i> kits;
    ...
    Crashlytics(Answers answers2, Beta beta2, CrashlyticsCore crashlyticsCore) {
        ...
        this.kits = Collections.unmodifiableCollection(Arrays.asList(new C0150i[]{answers2, beta2, crashlyticsCore}));
    }
    ...
    public Collection<? extends C0150i> getKits() {
        return this.kits;
    }

    public static Crashlytics getInstance() {
        return (Crashlytics) C0139c.m385a(Crashlytics.class);
    }
    ...
    public void setDebugMode(boolean z) {
        C0139c.m394g().mo288d(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        C0139c.m394g().mo288d(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return C0139c.m395h();
    }
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        C0139c.m394g().mo288d(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
