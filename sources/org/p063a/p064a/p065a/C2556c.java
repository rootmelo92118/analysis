...
public class C2556c implements C2553a {
    ...
    /* renamed from: c */
    private int[] f9069c = new int[96];

    /* renamed from: d */
    private int[] f9070d = new int[8];

    /* renamed from: e */
    private int[] f9071e = new int[12];

    /* renamed from: f */
    private int[] f9072f = new int[4];

    /* renamed from: a */
    private static int m11895a(int i, int i2) {
        return (i >>> i2) + (i << (32 - i2));
    }

    /* renamed from: a */
    private int m11896a(byte[] bArr, int i) {
        int i2 = 0;
    ...
    /* renamed from: a */
    private void m11897a(int i, byte[] bArr, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            bArr[(3 - i3) + i2] = (byte) i;
            i >>>= 8;
        }
    ...
    /* renamed from: a */
    private static void m11898a(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    /* renamed from: a */
    private void m11899a(boolean z, byte[] bArr) {
        byte[] bArr2 = bArr;
        int[] iArr = new int[8];
        int[] iArr2 = new int[4];
        int[] iArr3 = new int[4];
        ...
        if (length != 16) {
            if (length == 24) {
                iArr[0] = m11896a(bArr2, 0);
                iArr[1] = m11896a(bArr2, 4);
                iArr[2] = m11896a(bArr2, 8);
                iArr[3] = m11896a(bArr2, 12);
                iArr[4] = m11896a(bArr2, 16);
                iArr[5] = m11896a(bArr2, 20);
                iArr[6] = iArr[4] ^ -1;
                iArr[7] = iArr[5] ^ -1;
            } else if (length == 32) {
                iArr[0] = m11896a(bArr2, 0);
                ...
                iArr[4] = m11896a(bArr2, 16);
                iArr[5] = m11896a(bArr2, 20);
                iArr[6] = m11896a(bArr2, 24);
                iArr[7] = m11896a(bArr2, 28);
            } else {
        ...
        m11900a(iArr2, f9062g, 0);
        for (int i2 = 0; i2 < 4; i2++) {
            iArr2[i2] = iArr2[i2] ^ iArr[i2];
        }
        m11900a(iArr2, f9062g, 4);
        if (!this.f9068b) {
            for (int i3 = 0; i3 < 4; i3++) {
                iArr3[i3] = iArr2[i3] ^ iArr[i3 + 4];
            }
            m11900a(iArr3, f9062g, 8);
            if (z) {
                this.f9070d[0] = iArr[0];
                this.f9070d[1] = iArr[1];
                this.f9070d[2] = iArr[2];
                this.f9070d[3] = iArr[3];
                m11906c(45, iArr, 0, this.f9069c, 16);
                m11898a(15, iArr, 0, this.f9071e, 4);
                m11898a(17, iArr, 0, this.f9069c, 32);
                m11906c(34, iArr, 0, this.f9069c, 44);
                m11898a(15, iArr, 4, this.f9069c, 4);
                m11898a(15, iArr, 4, this.f9071e, 0);
                m11898a(30, iArr, 4, this.f9069c, 24);
                m11906c(34, iArr, 4, this.f9069c, 36);
                m11898a(15, iArr2, 0, this.f9069c, 8);
                m11898a(30, iArr2, 0, this.f9069c, 20);
                this.f9071e[8] = iArr2[1];
                this.f9071e[9] = iArr2[2];
                this.f9071e[10] = iArr2[3];
                this.f9071e[11] = iArr2[0];
                m11906c(49, iArr2, 0, this.f9069c, 40);
                this.f9069c[0] = iArr3[0];
                this.f9069c[1] = iArr3[1];
                this.f9069c[2] = iArr3[2];
                this.f9069c[3] = iArr3[3];
                m11898a(30, iArr3, 0, this.f9069c, 12);
                m11898a(30, iArr3, 0, this.f9069c, 28);
                m11906c(51, iArr3, 0, this.f9070d, 4);
                return;
            }
            this.f9070d[4] = iArr[0];
            this.f9070d[5] = iArr[1];
            this.f9070d[6] = iArr[2];
            this.f9070d[7] = iArr[3];
            m11907d(45, iArr, 0, this.f9069c, 28);
            m11903b(15, iArr, 0, this.f9071e, 4);
            m11903b(17, iArr, 0, this.f9069c, 12);
            m11907d(34, iArr, 0, this.f9069c, 0);
            m11903b(15, iArr, 4, this.f9069c, 40);
            m11903b(15, iArr, 4, this.f9071e, 8);
            m11903b(30, iArr, 4, this.f9069c, 20);
            m11907d(34, iArr, 4, this.f9069c, 8);
            m11903b(15, iArr2, 0, this.f9069c, 36);
            m11903b(30, iArr2, 0, this.f9069c, 24);
            this.f9071e[2] = iArr2[1];
            this.f9071e[3] = iArr2[2];
            this.f9071e[0] = iArr2[3];
            this.f9071e[1] = iArr2[0];
            m11907d(49, iArr2, 0, this.f9069c, 4);
            this.f9069c[46] = iArr3[0];
            this.f9069c[47] = iArr3[1];
            this.f9069c[44] = iArr3[2];
            this.f9069c[45] = iArr3[3];
            m11903b(30, iArr3, 0, this.f9069c, 32);
            m11903b(30, iArr3, 0, this.f9069c, 16);
            m11906c(51, iArr3, 0, this.f9070d, 0);
        } else if (z) {
            this.f9070d[0] = iArr[0];
            this.f9070d[1] = iArr[1];
            this.f9070d[2] = iArr[2];
            this.f9070d[3] = iArr[3];
            m11898a(15, iArr, 0, this.f9069c, 4);
            m11898a(30, iArr, 0, this.f9069c, 12);
            m11898a(15, iArr, 0, iArr4, 0);
            this.f9069c[18] = iArr4[2];
            this.f9069c[19] = iArr4[3];
            m11898a(17, iArr, 0, this.f9071e, 4);
            m11898a(17, iArr, 0, this.f9069c, 24);
            m11898a(17, iArr, 0, this.f9069c, 32);
            this.f9069c[0] = iArr2[0];
            this.f9069c[1] = iArr2[1];
            this.f9069c[2] = iArr2[2];
            this.f9069c[3] = iArr2[3];
            m11898a(15, iArr2, 0, this.f9069c, 8);
            m11898a(15, iArr2, 0, this.f9071e, 0);
            m11898a(15, iArr2, 0, iArr4, 0);
            this.f9069c[16] = iArr4[0];
            this.f9069c[17] = iArr4[1];
            m11898a(15, iArr2, 0, this.f9069c, 20);
            m11906c(34, iArr2, 0, this.f9069c, 28);
            m11898a(17, iArr2, 0, this.f9070d, 4);
        } else {
            this.f9070d[4] = iArr[0];
            this.f9070d[5] = iArr[1];
            this.f9070d[6] = iArr[2];
            this.f9070d[7] = iArr[3];
            m11903b(15, iArr, 0, this.f9069c, 28);
            m11903b(30, iArr, 0, this.f9069c, 20);
            m11903b(15, iArr, 0, iArr4, 0);
            this.f9069c[16] = iArr4[0];
            this.f9069c[17] = iArr4[1];
            m11903b(17, iArr, 0, this.f9071e, 0);
            m11903b(17, iArr, 0, this.f9069c, 8);
            m11903b(17, iArr, 0, this.f9069c, 0);
            this.f9069c[34] = iArr2[0];
            this.f9069c[35] = iArr2[1];
            this.f9069c[32] = iArr2[2];
            this.f9069c[33] = iArr2[3];
            m11903b(15, iArr2, 0, this.f9069c, 24);
            m11903b(15, iArr2, 0, this.f9071e, 4);
            m11903b(15, iArr2, 0, iArr4, 0);
            this.f9069c[18] = iArr4[2];
            this.f9069c[19] = iArr4[3];
            m11903b(15, iArr2, 0, this.f9069c, 12);
            m11907d(34, iArr2, 0, this.f9069c, 4);
            m11898a(17, iArr2, 0, this.f9070d, 0);
        }
    }

    /* renamed from: a */
    private void m11900a(int[] iArr, int[] iArr2, int i) {
        int i2 = iArr[0] ^ iArr2[i + 0];
        int i3 = f9063h[(i2 >>> 24) & 255] ^ ((f9064i[i2 & 255] ^ f9066k[(i2 >>> 8) & 255]) ^ f9065j[(i2 >>> 16) & 255]);
        int i4 = iArr[1] ^ iArr2[i + 1];
        int i5 = (f9065j[(i4 >>> 24) & 255] ^ ((f9063h[i4 & 255] ^ f9064i[(i4 >>> 8) & 255]) ^ f9066k[(i4 >>> 16) & 255])) ^ i3;
        iArr[2] = iArr[2] ^ i5;
        iArr[3] = (m11895a(i3, 8) ^ i5) ^ iArr[3];
        int i6 = iArr[2] ^ iArr2[i + 2];
        int i7 = f9063h[(i6 >>> 24) & 255] ^ ((f9064i[i6 & 255] ^ f9066k[(i6 >>> 8) & 255]) ^ f9065j[(i6 >>> 16) & 255]);
        int i8 = iArr2[i + 3] ^ iArr[3];
        int i9 = (f9065j[(i8 >>> 24) & 255] ^ ((f9063h[i8 & 255] ^ f9064i[(i8 >>> 8) & 255]) ^ f9066k[(i8 >>> 16) & 255])) ^ i7;
        iArr[0] = iArr[0] ^ i9;
        iArr[1] = (i9 ^ m11895a(i7, 8)) ^ iArr[1];
    }

    /* renamed from: b */
    private static int m11901b(int i, int i2) {
        return (i << i2) + (i >>> (32 - i2));
    }

    /* renamed from: b */
    private int m11902b(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.f9072f[i3] = m11896a(bArr, (i3 * 4) + i);
            int[] iArr = this.f9072f;
            iArr[i3] = iArr[i3] ^ this.f9070d[i3];
        }
        m11900a(this.f9072f, this.f9069c, 0);
        m11900a(this.f9072f, this.f9069c, 4);
        m11900a(this.f9072f, this.f9069c, 8);
        m11904b(this.f9072f, this.f9071e, 0);
        m11900a(this.f9072f, this.f9069c, 12);
        m11900a(this.f9072f, this.f9069c, 16);
        m11900a(this.f9072f, this.f9069c, 20);
        m11904b(this.f9072f, this.f9071e, 4);
        m11900a(this.f9072f, this.f9069c, 24);
        m11900a(this.f9072f, this.f9069c, 28);
        m11900a(this.f9072f, this.f9069c, 32);
        int[] iArr2 = this.f9072f;
        iArr2[2] = this.f9070d[4] ^ iArr2[2];
        int[] iArr3 = this.f9072f;
        iArr3[3] = iArr3[3] ^ this.f9070d[5];
        int[] iArr4 = this.f9072f;
        iArr4[0] = iArr4[0] ^ this.f9070d[6];
        int[] iArr5 = this.f9072f;
        iArr5[1] = iArr5[1] ^ this.f9070d[7];
        m11897a(this.f9072f[2], bArr2, i2);
        m11897a(this.f9072f[3], bArr2, i2 + 4);
        m11897a(this.f9072f[0], bArr2, i2 + 8);
        m11897a(this.f9072f[1], bArr2, i2 + 12);
        return 16;
    }

    /* renamed from: b */
    private static void m11903b(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    /* renamed from: b */
    private void m11904b(int[] iArr, int[] iArr2, int i) {
        iArr[1] = iArr[1] ^ m11901b(iArr[0] & iArr2[i + 0], 1);
        iArr[0] = iArr[0] ^ (iArr2[i + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i + 3] | iArr[3]);
        iArr[3] = m11901b(iArr2[i + 2] & iArr[2], 1) ^ iArr[3];
    }

    /* renamed from: c */
    private int m11905c(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.f9072f[i3] = m11896a(bArr, (i3 * 4) + i);
            int[] iArr = this.f9072f;
            iArr[i3] = iArr[i3] ^ this.f9070d[i3];
        ...
        m11900a(this.f9072f, this.f9069c, 28);
        m11900a(this.f9072f, this.f9069c, 32);
        m11904b(this.f9072f, this.f9071e, 8);
        m11900a(this.f9072f, this.f9069c, 36);
        m11900a(this.f9072f, this.f9069c, 40);
        m11900a(this.f9072f, this.f9069c, 44);
        int[] iArr2 = this.f9072f;
        iArr2[2] = iArr2[2] ^ this.f9070d[4];
        int[] iArr3 = this.f9072f;
        iArr3[3] = iArr3[3] ^ this.f9070d[5];
        int[] iArr4 = this.f9072f;
        iArr4[0] = iArr4[0] ^ this.f9070d[6];
    ...
    /* renamed from: c */
    private static void m11906c(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    /* renamed from: d */
    private static void m11907d(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    public int mo15778a(byte[] bArr, int i, byte[] bArr2, int i2) {
        if (!this.f9067a) {
            ...
            return this.f9068b ? m11902b(bArr, i, bArr2, i2) : m11905c(bArr, i, bArr2, i2);
        } else {
    ...
    public void mo15779a(boolean z, C2562b bVar) {
        if (bVar instanceof C2566a) {
            m11899a(z, ((C2566a) bVar).mo15792a());
            this.f9067a = true;
            return;
        }
