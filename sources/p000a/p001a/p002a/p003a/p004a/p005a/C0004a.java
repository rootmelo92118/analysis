...
public abstract class C0004a<T> implements C0006c<T> {
    ...
    /* renamed from: a */
    public final synchronized T mo18a(Context context, C0007d<T> dVar) {
        T a;
        a = mo17a(context);
        if (a == null) {
            a = this.f6a != null ? this.f6a.mo18a(context, dVar) : dVar.load(context);
            m6b(context, a);
        }
        return a;
    }
    ...
    /* renamed from: b */
    private void m6b(Context context, T t) {
        if (t != null) {
            mo19a(context, t);
            return;
        }
