...
class C0013e implements C0017f {
    ...
    public C0009b mo31a() {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            C0139c.m394g().mo281a("Fabric", "AdvertisingInfoServiceStrategy cannot be called on the main thread");
            return null;
        }
        try {
            this.f15a.getPackageManager().getPackageInfo("com.android.vending", 0);
            C0015a aVar = new C0015a();
            Intent intent = new Intent("com.google.android.gms.ads.identifier.service.START");
            intent.setPackage("com.google.android.gms");
            try {
                if (this.f15a.bindService(intent, aVar, 1)) {
                    try {
                        C0016b bVar = new C0016b(aVar.mo33a());
                        C0009b bVar2 = new C0009b(bVar.mo36a(), bVar.mo38b());
                        this.f15a.unbindService(aVar);
                        return bVar2;
                    } catch (Exception e) {
                        C0139c.m394g().mo289d("Fabric", "Exception in binding to Google Play Service to capture AdvertisingId", e);
                        this.f15a.unbindService(aVar);
                    }
                } else {
                    C0139c.m394g().mo281a("Fabric", "Could not bind to Google Play Service to capture AdvertisingId");
                    return null;
                }
            } catch (Throwable th) {
                C0139c.m394g().mo282a("Fabric", "Could not bind to Google Play Service to capture AdvertisingId", th);
            }
        } catch (PackageManager.NameNotFoundException unused) {
            C0139c.m394g().mo281a("Fabric", "Unable to find Google Play Services package name");
            return null;
        } catch (Exception e2) {
            C0139c.m394g().mo282a("Fabric", "Unable to determine if Google Play Services is available", (Throwable) e2);
            return null;
        }
    }
    ...
    private static final class C0015a implements ServiceConnection {
        ...
        /* renamed from: b */
        private final LinkedBlockingQueue<IBinder> f17b;

        private C0015a() {
            this.f16a = false;
            this.f17b = new LinkedBlockingQueue<>(1);
        }

        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            try {
                this.f17b.put(iBinder);
        ...
        public IBinder mo33a() {
            if (this.f16a) {
                C0139c.m394g().mo290e("Fabric", "getBinder already called");
            }
            this.f16a = true;
            try {
                return this.f17b.poll(200, TimeUnit.MILLISECONDS);
            } catch (InterruptedException unused) {
                return null;
            }
        }
    ...
    private static final class C0016b implements IInterface {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:6:?, code lost:
            p000a.p001a.p002a.p003a.C0139c.m394g().mo281a("Fabric", "Could not get parcel from Google Play Service to capture AdvertisingId");
         */
        ...
        public java.lang.String mo36a() {
            /*
                ...
                android.os.IBinder r2 = r5.f18a     // Catch:{ Exception -> 0x0024 }
                r3 = 1
                r4 = 0
            ...
            L_0x0022:
                ...
                goto L_0x0037
            L_0x0024:
                a.a.a.a.l r2 = p000a.p001a.p002a.p003a.C0139c.m394g()     // Catch:{ all -> 0x0022 }
                java.lang.String r3 = "Fabric"
                java.lang.String r4 = "Could not get parcel from Google Play Service to capture AdvertisingId"
                r2.mo281a((java.lang.String) r3, (java.lang.String) r4)     // Catch:{ all -> 0x0022 }
                r1.recycle()
                r0.recycle()
                r2 = 0
            L_0x0036:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
            p000a.p001a.p002a.p003a.C0139c.m394g().mo281a("Fabric", "Could not get parcel from Google Play Service to capture Advertising limitAdTracking");
         */
        /* JADX WARNING: Failed to process nested try/catch */
        ...
        public boolean mo38b() {
            /*
                ...
                android.os.IBinder r4 = r6.f18a     // Catch:{ Exception -> 0x0025 }
                r5 = 2
            ...
            L_0x0023:
                ...
                goto L_0x0037
            L_0x0025:
                a.a.a.a.l r3 = p000a.p001a.p002a.p003a.C0139c.m394g()     // Catch:{ all -> 0x0023 }
                ...
                r3.mo281a((java.lang.String) r4, (java.lang.String) r5)     // Catch:{ all -> 0x0023 }
            L_0x0030:
                r1.recycle()
                r0.recycle()
                return r2
